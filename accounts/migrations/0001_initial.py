# Generated by Django 4.1.7 on 2023-05-07 09:36
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('profile_image', models.ImageField(blank=True, null=True, upload_to=accounts.models.user_profile_image_path, verbose_name='عکس پروفایل')),
                ('cover_image', models.ImageField(blank=True, null=True, upload_to=accounts.models.user_cover_image_path, verbose_name='عکس کاور')),
                ...
                ('last_online', models.DateTimeField(blank=True, null=True, verbose_name='آخرین انلاین')),
            ],
            options={
                'verbose_name': 'کاربر',
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('from_user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='requested_followers', to=settings.AUTH_USER_MODEL)),
                ('to_user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='requested_followings', to=settings.AUTH_USER_MODEL)),
            ],
            options={
