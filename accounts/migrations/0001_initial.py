    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('profile_image', models.ImageField(blank=True, default='defaults/avatar-default.png', null=True, upload_to=accounts.models.user_profile_image_path, verbose_name='عکس پروفایل')),
                ('cover_image', models.ImageField(blank=True, null=True, upload_to=accounts.models.user_cover_image_path, verbose_name='عکس کاور')),
                ('background_image', models.ImageField(blank=True, null=True, upload_to=accounts.models.user_background_image_path, verbose_name='عکس بکگراند')),
